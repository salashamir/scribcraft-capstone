...
comment1 = Comment(comment_text="Great idea! I love the concept and think this would make a tremendous series!", user_id=user3.id, scrib_id=scrib3.id)
comment2 = Comment(comment_text="I wonder if you could include some more fantasy elements in this?", user_id=user6.id, scrib_id=scrib3.id)
comment3 = Comment(comment_text="These characters maybe could have some more adventurous traits", user_id=user2.id, scrib_id=scrib1.id)
